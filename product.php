...
<?php if(isset($_GET['p']) && $_GET['p']=='manpro'){?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<a class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" href="product.php?p=addpro"> <i class="glyphicon glyphicon-plus-sign"></i> Add Product </a>
				</div> <!-- /div-action -->				
...
<?php if(isset($_GET['p']) && $_GET['p']=='addpro'){?>
			      ...
			      <div class="modal-body">
			      	...
			      	<div class="col-sm-6">
				      	<div class="form-group">
				        	<label for="productImage" class="col-sm-3">Product Image: </label>
				        ...
				        <div class="form-group">
				        	<label for="productSource" class="col-sm-3">Product Source: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <input type="text" class="form-control" id="productSource" placeholder="Product Source" name="productSource" autocomplete="off" required>
							    </div>
				        </div> <!-- /form-group-->    
				        <div class="form-group">
				        	<label for="brandName" class="col-sm-3">Supplier Name: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
				        ...
				        <div class="form-group">
				        	...
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select type="text" class="form-control" id="Currency" placeholder="Currency" name="Currency" autocomplete="off" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->
			      	...
			      	<div class="col-sm-6">
				        <div class="form-group">
				        	<label for="productOrigin" class="col-sm-3">Prodcut Origin: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select type="text" class="form-control" id="productOrigin" placeholder="Product Origin" name="productOrigin" autocomplete="off" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->	
				        <div class="form-group">
				        	<label for="Seasonality" class="col-sm-3">Seasonality</label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select type="text" class="form-control" id="Seasonality" placeholder="Seasonality" name="Seasonality" autocomplete="off" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->		
				        <div class="form-group">
				        	<label for="dateOfPurchase" class="col-sm-3">Date Of Purchase: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select type="text" class="form-control" id="dateOfPurchase" placeholder="Date Of Purchase" name="dateOfPurchase" autocomplete="off" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->
				        <div class="form-group">
				        	<label for="purchaseMethod" class="col-sm-3">Purchase Method: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select class="form-control" id="purchaseMethod" name="purchaseMethod" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->
				        <div class="form-group">
				        	<label for="purchaseGroup" class="col-sm-3">Purchase Group: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select class="form-control" id="purchaseGroup" name="purchaseGroup" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->
				        <div class="form-group">
				        	<label for="purchaseBuddies" class="col-sm-3">Purchase Buddies: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
							      <select class="form-control" id="purchaseBuddies" name="purchaseBuddies" required>
							      	<option value="">~~SELECT~~</option>
							      </select>
							    </div>
				        </div> <!-- /form-group-->
				        ...
				        <div class="form-group">
				        	<label for="productStatus" class="col-sm-3">Status: </label>
				        	<label class="col-sm-1 control-label">: </label>
							    <div class="col-sm-8">
			        ...
			        <div class="col-sm-12">			        
			        	<button type="submit" class="btn btn-primary pull-right" id="createProductBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
			      	</div>			                	        
			      </div> <!-- /modal-body -->
...
<?php if(isset($_GET['p']) && $_GET['p']=='editpro'){?>
					...
					<div class="div-result">
						  ...
						  <div class="tab-content">
						    ...
						    <div role="tabpanel" class="tab-pane" id="productInfo">
						        ...
						        <div class="col-sm-12">			        
						        	<button type="submit" class="btn btn-success pull-right" id="editProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
						      	</div>
